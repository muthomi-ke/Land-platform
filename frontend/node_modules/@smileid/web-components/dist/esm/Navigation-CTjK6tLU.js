class o extends HTMLElement {
  connectedCallback() {
    const n = this.attachShadow({ mode: "open" }), i = document.createElement("style");
    i.textContent = `
:host {
  display: flex;
  max-inline-size: 100%;
...
.visually-hidden {
  ...
  inline-size: 1px;
    ...
    t.setAttribute("class", "back-button"), t.setAttribute("data-type", "icon"), t.setAttribute("part", "back-button"), t.setAttribute("type", "button"), t.innerHTML = `
      <svg
    ...
    e.setAttribute("class", "close-button"), e.setAttribute("data-type", "icon"), e.setAttribute("part", "close-button"), e.setAttribute("type", "button"), e.innerHTML = `
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
      ...
      >
    `, n.appendChild(i), this.showBackButton && n.appendChild(t), n.appendChild(e), this.backButton = t, this.backButton.addEventListener("click", () => this.handleBack()), this.closeButton = e, this.closeButton.addEventListener("click", () => this.handleClose());
  }
  disconnectedCallback() {
    this.backButton.removeEventListener("click", () => this.handleBack()), this.closeButton.removeEventListener("click", () => this.handleClose());
  }
  handleBack() {
...
"customElements" in window && !window.customElements.get("smileid-navigation") && window.customElements.define("smileid-navigation", o);
export {
  o as N
};
//# sourceMappingURL=Navigation-CTjK6tLU.js.map
